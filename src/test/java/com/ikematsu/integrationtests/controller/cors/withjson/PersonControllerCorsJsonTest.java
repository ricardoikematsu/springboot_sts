package com.ikematsu.integrationtests.controller.cors.withjson;
...
import com.ikematsu.data.dto.v1.security.TokenDTO;
...
public class PersonControllerCorsJsonTest extends AbstractIntegrationTest {
	...
	public void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		var content = given().spec(specification)
				.contentType(TestConfigs.CONTENT_TYPE_JSON)
					.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_IKEMATSU)
					.body(person)
					.when()
					.post()
				.then()
	...
	public void testCreateWithWrongOrigin() throws JsonMappingException, JsonProcessingException {
		...
		var content = given().spec(specification)
				.contentType(TestConfigs.CONTENT_TYPE_JSON)
					.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_OUTRO_IKEMATSU)
					.body(person)
				.when()
					.post()
				.then()
